...
# License: MIT
# https://github.com/adelerhof/proxmoxxmox/raw/main/LICENSE
...
# Use to copy all data from a Podman Home Assistant LXC to a Docker Home Assistant LXC.
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/adelerhof/proxmoxxmox/main/misc/copy-data/podman-home-assistant-copy-data-home-assistant-container.sh)"
